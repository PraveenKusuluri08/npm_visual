# https://github.com/amilstead/python-logging-examples/blob/master/README.md
# This is completely bonkers. Python has a built-in logging configuration update server.
# This means you can change the logging config for an entire runtime on the fly, without
